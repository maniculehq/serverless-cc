...
const bashTool = tool(
  "bash",
  "Run a bash command in the sandboxed in-memory shell (just-bash). Returns stdout, stderr and exit code. The workspace root is " + WORKSPACE + ".",
...
const writeTool = tool(
  "write_file",
  "Create or overwrite a text file in the sandbox filesystem.",
...
const lsTool = tool(
  "ls",
  "List a directory in the sandbox filesystem.",
...
export const TOOL_NAMES = [
  ...
  "mcp__sandbox__edit_file",
  "mcp__sandbox__ls",
];

export const sandboxServer = createSdkMcpServer({
  name: "sandbox",
  version: "0.1.0",
